        ...
        <div className="grid md:grid-cols-3 gap-12">
          ...
          <div className="md:col-span-2 space-y-12">
            ...
            <section className="space-y-4">
              ...
              <ul className="space-y-4 text-white/70 leading-relaxed">
                <li className="flex items-start gap-3">
                  ...
                  <div>
                    <strong className="text-white">Cloud Architecture & Routing:</strong> Architected AWS EC2 infrastructure for staging and production. Configured Nginx reverse proxies for secure subdomain routing and utilized PM2 for zero-downtime deployments.
                  </div>
                </li>
                <li className="flex items-start gap-3">
                  <CheckCircle className="w-5 h-5 text-blue-light shrink-0 mt-1" />
                  <div>
                    <strong className="text-white">Backend & Database:</strong> Developed scalable Node.js/NestJS services using PostgreSQL and Prisma to manage complex financial tracking and logistics relational data.
                  </div>
                </li>
                <li className="flex items-start gap-3">
                  <CheckCircle className="w-5 h-5 text-blue-light shrink-0 mt-1" />
                  <div>
                    <strong className="text-white">Core Features:</strong> Built modules for retailer profile management, tiered promotions, and a delivery logistics system featuring photo proof-of-delivery.
                  </div>
                </li>
              </ul>
            </section>
            ...
            <section className="space-y-4">
              ...
              <ul className="space-y-3 mt-4 text-white/70">
                <li className="flex items-start gap-3">
            ...
            <div className="p-6 rounded-2xl glass-card">
              ...
              <div className="flex flex-col gap-3">
                <div className="flex items-center gap-3 p-2 rounded-lg bg-white/5 border border-white/10">
                  ...
                  <span className="text-sm text-white/80">Next.js, Telegram Mini-App</span>
                </div>
                <div className="flex items-center gap-3 p-2 rounded-lg bg-white/5 border border-white/10">
                  ...
                  <span className="text-sm text-white/80">Node.js, NestJS</span>
                </div>
                <div className="flex items-center gap-3 p-2 rounded-lg bg-white/5 border border-white/10">
                  ...
                  <span className="text-sm text-white/80">PostgreSQL, Prisma</span>
                </div>
                <div className="flex items-center gap-3 p-2 rounded-lg bg-white/5 border border-white/10">
                  ...
                  <span className="text-sm text-white/80">AWS EC2, Nginx, PM2</span>
                </div>
              </div>
            </div>
            ...
            <div className="p-6 rounded-2xl glass-card">
              ...
              <ul className="space-y-3 text-sm text-white/70">
                <li className="flex justify-between border-b border-white/5 pb-2">
                  <span>Role</span>
                  <span className="text-white text-right">Full Stack &<br/>Cloud Engineer</span>
                </li>
